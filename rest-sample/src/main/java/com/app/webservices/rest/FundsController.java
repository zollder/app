...
import com.app.domain.Fund;
import com.app.services.FundService;
...
public class FundsController
{
	...
	public ModelAndView createFund(@RequestBody Fund fund_p, HttpServletResponse httpResponse_p, WebRequest request_p)
	{
		Fund createdFund;
	...
	public ModelAndView updateFund(@RequestBody Fund fund_p, @PathVariable("fundId") String fundId_p, HttpServletResponse httpResponse_p)
	{
	...
	public ModelAndView removeFund(@PathVariable("fundId") String fundId_p, HttpServletResponse httpResponse_p)
	{
